...
import org.lamisplus.modules.pharmacy.PharmacyModule;
...
@WebAppConfiguration
@SpringBootTest(classes = { PharmacyModule.class, MockMvcConfiguration.class })
@ActiveProfiles("integration-test")
@ContextConfiguration(initializers = MockAcrossServletContextInitializer.class)
public class ITpharmacyApplication
{
	@Autowired
